...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		// Ajax로 form데이터를 전송하기 위해 FormData 객체에 담기. // key, value 값으로 담김
		...
		$.ajax({
			...
			data: formData,
			contentType: false, // 필수 : x-www-fome-urlencoded로 파싱되는것을 방지
			processData: false, // 필수 : contentType을 false로 줫을때 querystring 자동 설정됨 해제.
